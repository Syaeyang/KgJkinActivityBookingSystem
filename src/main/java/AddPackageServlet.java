...
public class AddPackageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:sqlserver://your-server.database.windows.net:1433;database=your-database;user=your-username@your-server;password=your-password;encrypt=true;trustServerCertificate=false;loginTimeout=30;")) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            try (Connection con = DriverManager.getConnection("jdbc:sqlserver://your-server.database.windows.net:1433;database=your-database;user=your-username@your-server;password=your-password;encrypt=true;trustServerCertificate=false;loginTimeout=30;")) {
                String sql = "INSERT INTO package(packagename, packageprice, packageduration, packagedetails) OUTPUT INSERTED.packageid VALUES(?, ?, ?, ?)";
