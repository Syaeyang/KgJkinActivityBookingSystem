  ...
  <main>
    ...
    <section class="booking-section">
      ...
      <div class="booking-section">
        <% 
          PreparedStatement slotStmt = null;
          ResultSet slotRs = null;
          try {
              String slotQuery = "SELECT SLOTID, SLOTSTART, SLOTEND, AVAILABILITY FROM SLOT WHERE AVAILABILITY > 0 ORDER BY SLOTID";
              slotStmt = con.prepareStatement(slotQuery);
              slotRs = slotStmt.executeQuery();
        %>
        ...
        <form action="CreateBookingServlet" method="post">
          <div class="summary-container">
            ...
            <select id="slot" name="slot" required>
              ...
              <% while (slotRs.next()) { %>
                <option value="<%= slotRs.getInt("SLOTID") %>">
                  <%= slotRs.getString("SLOTSTART") %> - <%= slotRs.getString("SLOTEND") %> (Available: <%= slotRs.getInt("AVAILABILITY") %>)
                </option>
              <% } %>
            </select>
